...
\index{HEALTH AND SAFETY; NUISANCES!GENERAL PROVISIONS!Assessable Current Services}
...
\index{HEALTH AND SAFETY; NUISANCES!GENERAL PROVISIONS!Tree Disease}
...
\section{Public Nuisances Affecting Health\footnote{Penalty, see SEC. 10.99}}
\index{HEALTH AND SAFETY; NUISANCES!NUISANCES!Public Nuisances Affecting Health}
...
\section{Public Nuisances Affecting Morals and Decency\footnote{Penalty, see SEC. 10.99}}
\index{HEALTH AND SAFETY; NUISANCES!NUISANCES!Public Nuisances Affecting Morals and Decency}
...
\index{HEALTH AND SAFETY; NUISANCES!NUISANCES!Public Nuisances Affecting Peace and Safety}
...
\subchapter{ADMINISTRATIVE OFFENSES, ABATEMENT, AND RECOVERY OF COST}
\section{Administrative Offenses and Abatement Procedure}
\index{HEALTH AND SAFETY; NUISANCES!NUISANCES!Administrative Offenses and Abatement Procedure}
...
\end{enumerate}
\subsection{Administrative Fine.}
...
\subsubsection{Notice and Order for Abatement.}
...
\index{HEALTH AND SAFETY; NUISANCES!NUISANCES!Recovery of Cost}
\subsection{Personal Liability}
...
\index{HEALTH AND SAFETY; NUISANCES!WEEDS!Weeds and Grass}
\subsection{}
...
\subchapter{OPEN BURNING}

\setcounter{section}{59}
\section{Definitions}
\index{HEALTH AND SAFETY; NUISANCES!OPEN BURNING!Definitions}
...
\index{HEALTH AND SAFETY; NUISANCES!OPEN BURNING!Prohibited Activities}
\subsection{}
...
\index{HEALTH AND SAFETY; NUISANCES!OPEN BURNING}
...
\index{HEALTH AND SAFETY; NUISANCES!OPEN BURNING!Purposes Allowed for Open Burning}
\subsection{}
...
\index{HEALTH AND SAFETY; NUISANCES!OPEN BURNING!Permit Application for Open Burning; Permit Fees}
\subsection{}
...
\index{HEALTH AND SAFETY; NUISANCES!OPEN BURNING!Permit Process for Open Burning}
...
\index{HEALTH AND SAFETY; NUISANCES!OPEN BURNING!Permit Holder Responsibility}
\subsection{}
...
\index{HEALTH AND SAFETY; NUISANCES!OPEN BURNING!Revocation of Open Burning Permit}
...
\index{HEALTH AND SAFETY; NUISANCES!OPEN BURNING!Denial of Open Burning Permit}
...
\index{HEALTH AND SAFETY; NUISANCES!OPEN BURNING!Burning Ban or Air Quality Alert}
...
\index{HEALTH AND SAFETY; NUISANCES!OPEN BURNING!Rules and Laws Adopted by Reference}
