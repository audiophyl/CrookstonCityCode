...
\section{Definitions}
\index{TRAFFIC REGULATIONS!Definitions}
...
\section{Application}
\index{TRAFFIC REGULATIONS!Application}
...
\index{TRAFFIC REGULATIONS!Minnesota Statutes Adopted by Reference}
...
\section{Scope}
\index{TRAFFIC REGULATIONS!Scope}
...
\index{TRAFFIC REGULATIONS!Failing to Comply with Orders of Officer}
...
\index{TRAFFIC REGULATIONS!Placing Unauthorized Traffic-Control Signals}
...
\index{TRAFFIC REGULATIONS!Tampering with Traffic-Control Devices}
...
\index{TRAFFIC REGULATIONS!City May Authorize Temporary Restrictions}
...
\section{Penalty}
\index{TRAFFIC REGULATIONS!Penalty}
