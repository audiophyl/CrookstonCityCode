...
\index{ZONING!GENERAL PROVISIONS!Intent and Purpose}
...
\index{ZONING!GENERAL PROVISIONS!Rules of Language Construction}
...
\section{Definitions}
\index{ZONING!GENERAL PROVISIONS!Definitions}
...
\begin{description}
    ...
    \item[REGISTERED LAND SURVEY] A survey map of registered land designed to simplify a complicated metes and bounds description, designating the same into a tract or tracts of a Registered Land Survey Number (see M.S. \textsection 508.47, as it may be amended from time to time).
    ...
    \item[SIGN, BILLBOARD] Any sign that does not meet the requirements of an off-premise sign which displays, advertises, identifies, or directs attention to a business, service, activity, or place at a location which is not on the same premises where such sign is located.
    ...
    \item[SIGN, OFF-PREMISE] A sign which displays, advertises, identifies, or directs attention to a business, service, activity, or place at a location which is not on the same premises where such sign is located and does not exceed 25 square feet in surface area and 6 feet from the average grade to the top of the sign.
...
\index{ZONING!GENERAL PROVISIONS!Application and Interpretation}
\subsection{}
...
\index{ZONING!GENERAL PROVISIONS!Existing Lots}
...
\index{ZONING!GENERAL PROVISIONS!Separability}
...
\index{ZONING!GENERAL PROVISIONS!Zoning Coordination}
...
\section{Foundations}
\index{ZONING!GENERAL PROVISIONS!Foundations}
...
\index{ZONING!ZONING DISTRICTS!Division of City into Districts}
...
\section{Zoning Map}
\index{ZONING!ZONING DISTRICTS!Zoning Map}
\subsection{}
...
\index{ZONING!RESIDENTIAL DISTRICTS!Farm Residence (FR)}
\subsection{Purpose}
...
\index{ZONING!RESIDENTIAL DISTRICTS!Single-Family Residential (R-1)}
\subsection{Purpose}
...
\index{ZONING!RESIDENTIAL DISTRICTS!One- and Two-Family Residential (R-2)}
\subsection{Purpose}
...
\index{ZONING!RESIDENTIAL DISTRICTS!Multi-Family Residential (R-3)}
\subsection{Purpose}
...
\index{ZONING!BUSINESS DISTRICTS!Central Business District (C-1)}
\subsection{Purpose}
...
\index{ZONING!BUSINESS DISTRICTS!Highway Business District (C-2)}
\subsection{Purpose}
...
\index{ZONING!BUSINESS DISTRICTS!Shopping Center District (C-3)}
\subsection{Purpose}
...
\index{ZONING!BUSINESS DISTRICTS!Rural Commercial District (RC)}
\subsection{Purpose}
...
\index{ZONING!INDUSTRIAL DISTRICTS!Heavy Industry (I-1)}
\subsection{Purpose}
...
\index{ZONING!INDUSTRIAL DISTRICTS!Light Industry}
\subsection{Purpose}
...
\index{ZONING!SPECIAL USE DISTRICTS!Institutional (IN)}
\subsection{Purpose}
...
\index{ZONING!FLOODPLAIN DISTRICT!Statutory Authorization, Findings of Fact and Purpose}
...
\index{ZONING!FLOODPLAIN DISTRICT!General Provisions}
...
\index{ZONING!FLOODPLAIN DISTRICT!Establishment of Zoning Districts}
...
\index{ZONING!FLOODPLAIN DISTRICT!Floodway District (FW)}
\subsection{Permitted Uses}
\begin{enumerate}[{\indent}1)]
...
\index{ZONING!FLOODPLAIN DISTRICT!Flood Fringe District (FF)}
\subsection{Permitted Uses}
...
\index{ZONING!FLOODPLAIN DISTRICT!Subdivisions}
...
\index{ZONING!FLOODPLAIN DISTRICT!Public Utilities, Railroads, Roads and Bridges}
...
\index{ZONING!FLOODPLAIN DISTRICT!Manufactured Homes and Manufactured Home Parks and Placement of Recreational Vehicles}
\subsection{}
...
\index{ZONING!FLOODPLAIN DISTRICT!Administration}
...
\index{ZONING!FLOODPLAIN DISTRICT!Nonconforming Uses}
\subsection{}
...
\index{ZONING!FLOODPLAIN DISTRICT!Penalties for Violation}
\subsection{}
...
\section{Amendments}
\index{ZONING!FLOODPLAIN DISTRICT!Amendments}
...
\index{ZONING!NONCOMFORMING USES AND STRUCTURES!Continuation of Existing Use or Building}
...
\index{ZONING!NONCOMFORMING USES AND STRUCTURES!Nonconforming Buildings}
...
\index{ZONING!NONCOMFORMING USES AND STRUCTURES!Nonconforming Use of Building or Land}
...
\section{Purpose}
\index{ZONING!PLANNED UNIT DEVELOPMENT!Purpose}
...
\index{ZONING!PLANNED UNIT DEVELOPMENT!Permitted Uses}
...
\index{ZONING!PLANNED UNIT DEVELOPMENT!General Requirements}
...
\index{ZONING!PLANNED UNIT DEVELOPMENT![Repealed by Ordinance 10, Series 3]}

\section{Coordination with Subdivision Regulations}
\index{ZONING!PLANNED UNIT DEVELOPMENT!Coordination with Subdivision Regulations}
\subsection{}
...
\index{ZONING!PLANNED UNIT DEVELOPMENT!Pre-Application Meeting}
...
\index{ZONING!PLANNED UNIT DEVELOPMENT!Preliminary Development Plan}
\subsection{}
...
\index{ZONING!PLANNED UNIT DEVELOPMENT!Final Development Plan}
\begin{enumerate}[{\indent}A)]
...
\index{ZONING!PLANNED UNIT DEVELOPMENT!Enforcing Development Schedule}
...
\index{ZONING!PLANNED UNIT DEVELOPMENT!Conveyance and Maintenance of Common Open Space}
\subsection{}
...
\index{ZONING!PLANNED UNIT DEVELOPMENT!Standards for Common or Public Open Space}
...
\index{ZONING!PLANNED UNIT DEVELOPMENT!PUD Review and Amendments}
...
\section{Purpose}
\index{ZONING!PERFORMANCE STANDARDS!Purpose}
...
\index{ZONING!PERFORMANCE STANDARDS!Solar and Earth Sheltered Structures}
\begin{enumerate}[{\indent}A)]
...
\index{ZONING!PERFORMANCE STANDARDS!Wind Energy Conversion Systems (WECS)}
...
\index{ZONING!PERFORMANCE STANDARDS!Exterior Storage}
\subsection{}
...
\section{Refuse}
\index{ZONING!PERFORMANCE STANDARDS!Refuse}
\subsection{}
...
\index{ZONING!PERFORMANCE STANDARDS!Blight or Blighting Factors}
...
\section{Glare}
\index{ZONING!PERFORMANCE STANDARDS!Glare}
...
\index{ZONING!PERFORMANCE STANDARDS!Adult Use Establishments}
...
\section{Nuisances}
\index{ZONING!PERFORMANCE STANDARDS!Nuisances}
...
\section{Screening}
\index{ZONING!PERFORMANCE STANDARDS!Screening}
\subsection{}
...
\section{Landscaping}
\index{ZONING!PERFORMANCE STANDARDS!Landscaping}
...
\index{ZONING!PERFORMANCE STANDARDS!Permitted Encroachments}
...
\index{ZONING!PERFORMANCE STANDARDS!Accessory Buildings and Structures; Prohibited Dwelling Units}
...
\index{ZONING!PERFORMANCE STANDARDS!Tree and Woodland Preservation}
...
\index{ZONING!PERFORMANCE STANDARDS!Wetland Preservation}
...
\index{ZONING!PERFORMANCE STANDARDS!Traffic Control; Vacated Streets}
\subsection{}
...
\index{ZONING!PERFORMANCE STANDARDS!Access Drives and Access}
\subsection{}
...
\index{ZONING!PERFORMANCE STANDARDS!Private Sewer Systems}
...
\index{ZONING!PERFORMANCE STANDARDS!Mobile Home Parks}
\subsection{Purpose}
...
\index{ZONING!PERFORMANCE STANDARDS!Off-Street Parking}
\subsection{Location}
...
\index{ZONING!PERFORMANCE STANDARDS!Auto Service Station Standards}
\subsection{Lot Size}
...
\index{ZONING!PERFORMANCE STANDARDS!Drive-In Business Standards}
...
\section{Signs}
\index{ZONING!PERFORMANCE STANDARDS!Signs}
\subsection{Purpose}
...
Maximum sign surface height shall be 36 inches and sign length shall be limited to 50\% of the associated building face.
\paragraph{Materials}
...
\begin{enumerate}[{\indent}a)]
    ...
    \item Ground signs.
    \item Pole signs.
    \item Portable signs that are advertising signs located on the premises to which they have reference.
    \item Flashing signs, except those which “flash" outside of the message area.
    \item Changeable copy signs.
    \item Off-premise signs when authorized by conditional use permit upon a finding of the Council, among other required findings, that such off-premise sign promotes the public health, safety, and general welfare.
    \item Billboard signs when authorized by conditional use permit upon a finding of the Council, among other required findings, that such billboard sign promotes the public health, safety, and general welfare.
\end{enumerate}
\subsubsection{Performance Standards}
\paragraph{Billboard Signs.}
When authorized by conditional use permit, billboard signs may only be erected along U.S. Highway 2, U.S. Route 75, and their bypasses and shall:
\begin{enumerate}[{\indent}i)]
  ...
  \item not exceed 350 square feet in surface area and no portion of the sign shall extend beyond the regular face of the sign framework;
  \item not exceed 36 feet in maximum height from the average grade to the top of the billboard sign;
  \item have a minimum height of 12 feet from the average grade to the bottom of the billboard sign;
  \item have a maximum width of 30 feet;
  \item be at least twelve feet from the walk or grade line;
  \item be setback from the highway right of way at least 50 feet;
  \item not turn on an axis, rotate, revolve or otherwise physically move; and
  \item not contain more than one sign per facing.
\end{enumerate}
\paragraph{Wall Signs.}
Wall signs are limited to one per building face. Requirements for wall signs shall be the same as for the Historic District, except maximum sign surface height shall be one-third of building height.
\paragraph{Ground and Pole Signs.}
Only one ground sign or pole sign will be allowed per business or lot, except that a total of two ground or pole signs will be allowed if the lot involved has at least 200 lineal feet of frontage. Requirements for ground and pole signs are as follows:
\begin{center}
...
If the enforcing officer finds that any sign has been erected or is being maintained in violation of this section or that any sign is inadequately maintained or presents a safety hazard, the enforcing officer will give written notice of the violation to the installer of the sign and to the owner or manager of the property upon which the sign exists. If, after receiving notice, the sign is not removed or altered as required, the sign shall be deemed a public health or safety hazard and may be abated by the city under SEC. 94.01 of the city code.\footnote{Penalty, see 152.999}

\section{Home Occupations}
\index{ZONING!PERFORMANCE STANDARDS!Home Occupations}
...
\index{ZONING!PERFORMANCE STANDARDS!Manufactured Homes}
...
\section{Satellite Dish Antennas\footnote{Penalty, see 152.999}}
\index{ZONING!PERFORMANCE STANDARDS!Satellite Dish Antennas}
...
\section{Bed and Breakfast Inns\footnote{Penalty, see 152.999}}
\index{ZONING!PERFORMANCE STANDARDS!Bed and Breakfast Inns}
...
\index{ZONING!ADMINISTRATION AND ENFORCEMENT!Enforcing Officer}
...
\index{ZONING!ADMINISTRATION AND ENFORCEMENT!Appeals and Board of Zoning Appeals}
\subsection{}
...
\index{ZONING!ADMINISTRATION AND ENFORCEMENT!Powers and Duties of Planning Commission (See also SEC. 32.120 and SEC. 32.121)}
\subsection{}
...
\index{ZONING!ADMINISTRATION AND ENFORCEMENT!Zoning Amendments}
...
\index{ZONING!ADMINISTRATION AND ENFORCEMENT!Conditional Use Permits}
...
\begin{enumerate}[{\indent}1)]
    ...
    \item A boundary survey and preliminary building and site development plan.
\end{enumerate}
\subsection{Procedure\footnote{\textbf{Note:} If a mobile home park is converted to another use requiring a variance or zoning change, the Planning Commission must give notice of hearing to each occupant. See M.S. \textsection 327C.095, as it may be amended from time to time.}}
...
\section{Variances}
\index{ZONING!ADMINISTRATION AND ENFORCEMENT!Variances}
...
\index{ZONING!ADMINISTRATION AND ENFORCEMENT!Enforcement Provisions and Procedures}
...
\section{Penalty}
\index{ZONING!ADMINISTRATION AND ENFORCEMENT!Penalty}
