...
\section{Definitions}
\index{MUNICIPAL AND PUBLIC UTILITIES!GENERAL PROVISIONS!Definitions}
...
\index{MUNICIPAL AND PUBLIC UTILITIES!GENERAL PROVISIONS!Fixing Rates and Charges for Municipal Utilities}
...
\index{MUNICIPAL AND PUBLIC UTILITIES!GENERAL PROVISIONS!Contractual Contents}
...
\index{MUNICIPAL AND PUBLIC UTILITIES!RULES AND REGULATIONS RELATING TO MUNICIPAL UTILITIES!Billing, Payment, and Delinquency}
...
\index{MUNICIPAL AND PUBLIC UTILITIES!RULES AND REGULATIONS RELATING TO MUNICIPAL UTILITIES!Application, Connection and Sale of Service}
...
\index{MUNICIPAL AND PUBLIC UTILITIES!RULES AND REGULATIONS RELATING TO MUNICIPAL UTILITIES!Discontinuance of Service}
...
\index{MUNICIPAL AND PUBLIC UTILITIES!RULES AND REGULATIONS RELATING TO MUNICIPAL UTILITIES!Ownership of Municipal Utilities; Right of Entry}
\subsection{}
...
\index{MUNICIPAL AND PUBLIC UTILITIES!RULES AND REGULATIONS RELATING TO MUNICIPAL UTILITIES!Meter Accuracy}
...
\index{MUNICIPAL AND PUBLIC UTILITIES!RULES AND REGULATIONS RELATING TO MUNICIPAL UTILITIES!Unlawful Acts}
\subsection{}
...
\index{MUNICIPAL AND PUBLIC UTILITIES!RULES AND REGULATIONS RELATING TO MUNICIPAL UTILITIES!Municipal Utility Services and Charges a Lien}
\subsection{}
...
\index{MUNICIPAL AND PUBLIC UTILITIES!RULES AND REGULATIONS RELATING TO MUNICIPAL UTILITIES!Municipal Utility Service Outside the City}
...
\index{MUNICIPAL AND PUBLIC UTILITIES!RULES AND REGULATIONS RELATING TO MUNICIPAL UTILITIES!Delinquent Charges or Assessments}
...
\index{MUNICIPAL AND PUBLIC UTILITIES!RULES AND REGULATIONS RELATING TO MUNICIPAL UTILITIES!Violations; Penalty Surcharge}
\subsection{Purpose}
...
\section{Penalty}
\index{MUNICIPAL AND PUBLIC UTILITIES!RULES AND REGULATIONS RELATING TO MUNICIPAL UTILITIES!Penalty}
