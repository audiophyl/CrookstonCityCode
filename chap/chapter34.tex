...
\index{FINANCE AND TAXATION!ASSESSMENTS; FUNDS!Prepayment of Assessments}
\subsection{}
...
\index{FINANCE AND TAXATION!ASSESSMENTS; FUNDS!Special Assessment Policy}
...
\index{FINANCE AND TAXATION!ASSESSMENTS; FUNDS!Airport Fund}
...
\index{FINANCE AND TAXATION!ASSESSMENTS; FUNDS!Trust or Escrow for Fire or Explosion Losses}
...
\section{Purpose}
\index{FINANCE AND TAXATION!LODGING TAX!Purpose}
...
\section{Definitions}
\index{FINANCE AND TAXATION!LODGING TAX!Definitions}
...
\index{FINANCE AND TAXATION!LODGING TAX!Imposition of Tax}
\subsection{}
...
\section{Collection}
\index{FINANCE AND TAXATION!LODGING TAX!Collection}
...
\section{Refunds}
\index{FINANCE AND TAXATION!LODGING TAX!Refunds}
\subsection{}
...
\section{Penalties}
\index{FINANCE AND TAXATION!LODGING TAX!Penalties}
\subsection{}
...
\index{FINANCE AND TAXATION!LODGING TAX!Council Hearing}
\subsection{}
...
\index{FINANCE AND TAXATION!LODGING TAX!Deposit of Revenue; Distribution}
...
\section{Violations}
\index{FINANCE AND TAXATION!LODGING TAX!Violations}
